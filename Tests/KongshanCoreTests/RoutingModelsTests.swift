...
final class RoutingModelsTests: XCTestCase {
    ...
    func testSSHProxyTargetsValidateExactAddressesPortsAndDeduplicate() throws {
        ...
        settings.sshProxyTargets = [
            SSHProxyTarget(address: " 203.0.113.10 ", port: 2_222),
            SSHProxyTarget(address: "203.0.113.10", port: 2_222),
            SSHProxyTarget(address: "203.0.113.10", port: 22),
        ...
        XCTAssertThrowsError(try SSHProxyTarget(address: "203.0.113.10/24").validated())
