...
## 当前状态：v0.1.72 稳定用户态代理入口，候选已通过完整 M4（2026-08-08）
...
- 当前边界：安装版仍为 v0.1.71，v0.1.72 尚未提交、生成最终 DMG、安装或发布。替换必须正常退出旧版，
  确认系统代理/DNS/recovery/直连恢复并备份配置后原子安装；新 cdhash 需要重装 helper，再完成多轮
  系统代理/TUN 切换、公开端口稳定性、HTTP/HTTPS/SOCKS 数据面、资源占用与网络恢复终验。
